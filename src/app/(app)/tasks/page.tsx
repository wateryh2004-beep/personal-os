...
export default async function Tasks({ searchParams }: { searchParams: Promise<{ create?: string }> }) {
  ...
  return <TaskWorkspace lists={lists} tasks={tasks} initialCreateOpen={params.create === "1"} />;
}
