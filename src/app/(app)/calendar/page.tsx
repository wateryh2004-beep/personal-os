...
export default async function CalendarPage() {
  ...
  return <div className="[&>section]:rounded-lg [&>section]:border-[#deddd8] [&>section]:shadow-[0_1px_2px_rgb(24_24_27/0.04)] [&>section>div:first-child]:bg-[#fbfbfa] [&>section>div:first-child]:px-5"><CalendarWorkspace events={events} /></div>;
}
