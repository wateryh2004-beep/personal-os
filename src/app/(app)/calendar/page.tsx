...
export default async function CalendarPage({ searchParams }: { searchParams: Promise<{ create?: string }> }) {
  ...
  return <CalendarWorkspace events={events} categories={categories} timezone={timezone} scopeReady={(connection.oauth_scope_version ?? 1) >= 2} initialCreateOpen={params.create === "1"} />;
}
