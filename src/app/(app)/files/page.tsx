...
export default async function Files({ searchParams }: { searchParams: Promise<{ upload?: string }> }) {
  ...
  return <FilesWorkspace folders={data.folders} files={data.files} archivedFiles={data.archivedFiles} initialUpload={params.upload === "1"} />;
}
