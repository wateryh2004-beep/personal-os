...
const editorTheme = EditorView.theme({
  ...
  ".cm-tooltip.cm-note-link-completion": {
    zIndex: "20",
    overflow: "hidden",
    minWidth: "min(336px, calc(100vw - 24px))",
    maxWidth: "min(440px, calc(100vw - 24px))",
    padding: "5px",
    border: "1px solid color-mix(in srgb, var(--border) 78%, var(--accent) 22%)",
    borderRadius: "12px",
    backgroundColor: "var(--surface-elevated)",
    boxShadow: "0 18px 42px rgba(24, 24, 27, 0.12), 0 2px 8px rgba(24, 24, 27, 0.05)",
    fontFamily: "var(--font-sans)",
  },
  ".cm-note-link-completion > ul": {
    maxHeight: "min(344px, 46vh)",
    margin: "0",
    padding: "0",
    fontFamily: "var(--font-sans)",
    fontSize: "14px",
  ...
  ".cm-note-link-completion > ul > li:hover": {
    backgroundColor: "var(--surface-hover)",
    color: "var(--text-primary)",
  },
  ".cm-note-link-completion > ul > li[aria-selected]": {
    backgroundColor: "var(--accent-soft)",
    color: "var(--text-primary)",
  },
  ".cm-note-link-completion .cm-completionLabel": {
    overflow: "hidden",
    flex: "1",
    color: "inherit",
    fontWeight: "560",
  ...
  ".cm-note-link-completion .cm-completionMatchedText": {
    color: "var(--accent)",
    fontWeight: "650",
    textDecoration: "none",
  },
  ".cm-note-link-completion .cm-completionDetail": {
    maxWidth: "42%",
    overflow: "hidden",
    marginLeft: "auto",
